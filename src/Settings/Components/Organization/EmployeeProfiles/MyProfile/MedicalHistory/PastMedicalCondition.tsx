...
import { AddPastMedicalCondition } from "./AddPastMedicalCondition";

export const PastMedicalCondition = () => {
  ...
  return (
    <div>
      ...
      <div className="flex justify-between items-center">
        <h2 className="text-base text-accent">Past Medical Conditions</h2>
