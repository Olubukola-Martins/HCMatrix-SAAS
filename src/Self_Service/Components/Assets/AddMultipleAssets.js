...
const AddMultipleAssets = ({ open, handleClose }) => {
  ...
  return (
    <Modal open={open} onClose={handleClose}>
      <Themes>
        <div className="CModal scrollBar overflow-auto" style={{ width: 500, height: 500 }}>
          ...
          <div className="mt-3 mb-5 lg:px-6">
            <div>
              <label htmlFor="" className="text-sm font-medium">Import data for:</label>
            ...
            <div className="mt-3">
              <label htmlFor="" className="text-sm font-medium">Import based on:</label>
              <select name="" id="" className={inputStyle}>
