    ...
    <DashboardLayout>
      ...
      <div className="Container">
        <div className="flex items-center gap-3 font-extrabold ">
          ...
          <h2 className="text-xl md:text-2xl text-accent">New Form</h2>
        </div>
        <form className="bg-card px-5 py-7  rounded-md mt-7 ">
          ...
          <button type="button" className="transparentButton">Cancel</button>
