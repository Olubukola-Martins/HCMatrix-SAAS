...
import { useGetSingleRequisitionSetting } from "../../requisitions/hooks/setting/useGetSingleRequisitionSetting";
...
import { QUERY_KEY_FOR_REQUISITION_SETTING } from "../../requisitions/hooks/setting/useGetRequisitionSetting";
...
const ReimbursementPolicyForm = () => {
  ...
  const { data } = useGetSingleRequisitionSetting({
    type: "reimbursement",
    companyId,
    token,
  });
