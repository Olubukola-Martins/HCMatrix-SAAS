...
import { useCreateVehicleMaintenance } from "../hooks/useCreateVehicleMaintenance";
...
export const AddMaintenance: React.FC<IProps> = ({
  handleClose,
  open,
  vehicleId,
}) => {
  ...
  const { mutate, isLoading } = useCreateVehicleMaintenance();
