...
export const QUERY_KEY_FOR_POSITION_CHANGE_REQUISITIONS =
  "position-change-requisitions";
...
export const useGeTPositionChangeRequisitionRequisitions = (
  props: IGetDataProps
) => {
  const queryData = useQuery(
    [QUERY_KEY_FOR_POSITION_CHANGE_REQUISITIONS, props],
    () =>
      getData({
        ...props,
      }),
