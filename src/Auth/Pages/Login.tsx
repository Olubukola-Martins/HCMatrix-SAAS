...
const Login = () => {
  ...
  const showResetModal = (val: boolean) => {
  ...
  return (
    <div className="landingBg">
      <LoginSuccessModal
        open={openLoginModal}
        handleClose={() => showLoginModal(false)}
      />
      <ResetPasswordModal
        open={openResetModal}
        handleClose={() => showResetModal(false)}
      />
      <div className="signCard">
        ...
        <div className="pb-10 pt-12 px-1 md:px-7 text-center">
          ...
          <form className="flex flex-col">
            ...
            {showComp === "password" && (
              <div className="flex flex-col align-start mb-6">
